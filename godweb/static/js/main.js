...
function toggleSiteTheme() {
    ...
    if (body.classList.contains('light-mode')) {
        ...
        if (mobileThemeBtn) mobileThemeBtn.innerHTML = '<i class="fas fa-moon"></i> Chế\u0301 \u0111o\u0323 to\u0301i';
    } else {
        localStorage.setItem('siteTheme', 'dark');
        if (themeBtn) themeBtn.innerHTML = '<i class="fas fa-sun"></i>';
        if (mobileThemeBtn) mobileThemeBtn.innerHTML = '<i class="fas fa-sun"></i> Chế\u0301 \u0111o\u0323 sa\u0301ng';
    }
}
